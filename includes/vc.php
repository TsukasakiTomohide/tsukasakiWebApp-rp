...
<section style = "text-align: center">
    <div style = 'text-align; center; position: relative; top: -40px'>
        <form action = 'vc.submit.php' method = 'post'> <!--Data are transferred to vc.inc.php-->
            ...
            <input  type = "radio"  name = 'email'    value = 'Send Email'                                                    style = "position: relative; left: 355px;  top: -50px">                          <label style = "position: relative; left: 355px;  top: -52px">Yes</label>
            <input  type = "radio"  name = 'email'    value = 'Not Send'                                                      style = "position: relative; left: 355px;  top: -50px" checked>                  <label style = "position: relative; left: 355px;  top: -52px">No</label>
