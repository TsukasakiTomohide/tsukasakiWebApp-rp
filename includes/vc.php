...
<section style = "width: 1500px; text-align: center">
    <div style = 'text-align; center; position: relative; top: -40px'>
        <form action = 'vc.submit.php' method = 'post'> <!--Data are transferred to vc.inc.php-->
            <p style = "position: relative; left: -400px; top: 0px">Next One on One Meeting (when Goals Approved)</p>
            ...
            <?php for($i = 0; $i < 5; $i++){ ?>
                ...
                <input type = 'text'   name = 'Eval_<?php   echo($i+1); ?>t' value = 'Evaluation'                                 maxlength = '300' disabled                            style='position:relative;top:51px;width:100px;left:-56px'>
                <select                name = 'Eval_<?php   echo($i+1); ?>'                                                                         <?php echo($DisabledFinalEval);?>   style='position:relative;top:71px;width:108px;left:-168px;height: 50px;vertical-align:top'>
                ...
                <input type = 'text'   name = 'Res_<?php    echo($i+1); ?>t' value = 'Results of the quarter'                     maxlength = '300' disabled                            style='position:relative;top:-97px;width:568px'>
                <input type = 'text'   name = 'Per_<?php    echo($i+1); ?>t' value = 'Performance of the staff'                   maxlength = '300' disabled                            style='position:relative;top:-97px;width:568px'>
                <textarea              name = 'Res_<?php    echo($i+1); ?>'                                                       maxlength = '300' <?php echo($DisabledResSelf);?>     style='position:relative;top:-97px;width:570px;height:240px;resize:none;vertical-align:top;' wrap ='hard'><?php echo($vcThisPage["quarterResult_".($i+1)]);?></textarea>
                <textarea              name = 'Per_<?php    echo($i+1); ?>'                                                       maxlength = '300' <?php echo($DisabledPerformance);?> style='position:relative;top:-97px;width:570px;height:240px;resize:none;vertical-align:top;' wrap ='hard'><?php echo($vcThisPage["Performance_".($i+1)]);?></textarea>
            <?php } ?>
            </form>
        </div>
</section>
